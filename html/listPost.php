<div class="content">
	...
	<?php 
		include("../config.php");
		$sql = "SELECT user.userid, profile.name, post.* FROM post JOIN user ON post.userid = user.userid JOIN profile ON user.username = profile.username where ltrim(rtrim(content)) != '' ORDER BY post.datepost DESC, post.postid DESC";
